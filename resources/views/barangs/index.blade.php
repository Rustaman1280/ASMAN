                ...
                <tr class="hover:bg-slate-50 transition-colors">
                    ...
                    <td class="px-6 py-4 font-medium text-slate-900">
                        ...
                        @if($barang->detail_barang)
                            <p class="text-xs text-slate-400 mt-0.5 truncate max-w-xs">{{ $barang->detail_barang }}</p>
                        @endif
                    </td>
                    <td class="px-6 py-4">
                    ...
                    <td class="px-6 py-4">
                        @if($barang->lokasi)
                            <span class="font-medium text-slate-700">{{ $barang->lokasi->nama }}</span>
                            <span class="text-xs text-slate-400 block">{{ class_basename($barang->lokasi_type) }}</span>
                        @else
