                    ...
                    <tr class="hover:bg-blue-50/50 transition-colors"
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex justify-end space-x-2">
                                <a href="{{ route('ruangans.show', $item) }}" class="p-2 text-slate-400 hover:text-emerald-600 hover:bg-white rounded-lg border border-transparent hover:border-emerald-100 transition-all" title="Lihat Detail Barang">
